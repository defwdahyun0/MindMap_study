...
class RealtimeKeyword {
  ...
  RealtimeKeyword(this.id, this.keyword);
}

class KeywordTile extends StatelessWidget {
  KeywordTile(this._realtimeKeyword);

  final RealtimeKeyword _realtimeKeyword;

  @override
  Widget build(BuildContext context) {
    return ListTile(
      title: Text(_realtimeKeyword.id + '  ' + _realtimeKeyword.keyword),
    );
  }
}
